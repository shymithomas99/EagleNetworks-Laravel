        ...
        <div class="cookie-modal-box">
            ...
            <div class="cookie-modal-body">
                ...
                <div class="cookie-option-box">
                    ...
                    <div class="cookie-option-left">

                        <div class="cookie-icon orange">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-shield-check mt-0.5 flex-shrink-0"
                                data-loc="client/src/components/CookiePreferencesModal.tsx:87"
                    ...
                    <div class="cookie-option-left">
                        ...
                        <div class="cookie-icon orange">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-chart-no-axes-column mt-0.5 flex-shrink-0"
                                data-loc="client/src/components/CookiePreferencesModal.tsx:110"
...
<script>
    const expandingCta = document.getElementById("expandingCta");
    const toggleBtn = document.querySelector(".cta-toggle-btn");

    toggleBtn.addEventListener("click", () => {
        expandingCta.classList.toggle("expanded");
    });
</script>
<script>
...
<script>
    ...
    const desktopDetailBox = document.getElementById("desktopDetailBox");
    const desktopTitle = document.getElementById("desktopDetailTitle");
    const desktopDescription = document.getElementById("desktopDetailDescription");
    ...
    serviceCards.forEach((card) => {
        ...
        card.addEventListener("click", () => {
            ...
            // remove all mobile detail boxes
            document.querySelectorAll(".mobile-detail-wrapper").forEach((box) => {
                box.remove();
            });

            // hide desktop detail box
            desktopDetailBox.classList.remove("active");
            ...
            if (isMobile) {
                ...
                wrapper.className = "col-12 mobile-detail-wrapper";

                wrapper.innerHTML = `
    <div class="service-detail-box mobile-detail-box active">
      <h3>${title}</h3>
      <p>${description}</p>
    </div>
  `;
                ...
                // insert directly after clicked column
                parentCol.after(wrapper);
            ...
            ========================= */
                ...
                desktopDetailBox.classList.add("active");
