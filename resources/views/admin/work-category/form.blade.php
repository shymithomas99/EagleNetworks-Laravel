    ...
    <div class="container px-5 py-5">
        <div class="card">
            ...
            <form method="POST" action="{{ $workCategory->id ? route('admin.work-category.update',$workCategory) : route('admin.work-category.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-6 my-3">
                        <button type="submit" class="btn btn-primary w-100">{{ $workCategory->id ? 'Update' : 'Save' }}</button>
                    </div>
                    
                    <div class="col-6 my-3">
                        <a class="btn btn-secondary w-100" href="{{ route('admin.work-category.index') }}">Cancel</a>
                    </div>
                </div>
            </form>
            </div>
