                        ...
                        <tbody>
                            ...
                            @forelse ($collections as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->published == true)
                                            <a class="mx-2 col btn btn-success"
                                                href="{{ route('admin.blog-category.unpublish', $item->id) }}">
                                                Publish
                                            </a>
                                        @else
                                            <a class="mx-2 col btn btn-danger"
                                                href="{{ route('admin.blog-category.publish', $item->id) }}">
                                                Unpublish
                                            </a>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="row">
                                            <a class="mx-2 col btn btn-success" href="{{ route('admin.blog-category.edit', $item) }}">
